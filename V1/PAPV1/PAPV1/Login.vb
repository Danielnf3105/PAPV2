...
Public Class Login
    ...
    Private Sub BttLogin_Click(sender As Object, e As EventArgs) Handles BttLogin.Click
        ...
        Try
            ...
            Dim sql As String = "SELECT * FROM dono WHERE user_dono='" & TxtUserName.Text & "' AND pass_dono = '" & TxtPassword.Text & "'"
            ...
            If Trim(dr.Item(7)) = TxtUserName.Text And Trim(dr.Item(8)) = TxtPassword.Text Then

                MsgBox("Bem-vindo " & dr.Item(2) & "!")
